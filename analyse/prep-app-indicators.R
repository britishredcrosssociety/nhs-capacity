...
open_trusts %>%
  ...
  rename(
    `Trust Name` = org_name,
    `Trust Code` = org_code,
    `Total Night Beds Occupied` = num_bed_occupied_total,
    `General Acute Night Beds Occupied` = num_bed_occupied_general_acute,
    `Learning Disabilities Night Beds Occupied` = num_bed_occupied_learning_disabilities,
    `Maternity Night Beds Occupied` = num_bed_occupied_maternity,
    `Mental Illness Night Beds Occupied` = num_bed_occupied_mental_illness,
