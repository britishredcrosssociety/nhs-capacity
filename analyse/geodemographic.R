...
la_pop %>% 
  write_csv("data/raw/geodem_la_population.csv")
...
geog_names %>% 
  write_csv("data/raw/geodem_la_county_names_codes.csv")

# ---- NHSE/LA Trust Lookup ----
...
hosp_eng %>% 
  write_csv("data/raw/geodem_eng_hospitals.csv")
...
write_csv(trust_lad, "data/raw/geodem_la_trust_lookup.csv")